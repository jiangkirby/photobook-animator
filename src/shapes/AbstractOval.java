 ...
 * AbstractOval class.
 */
public abstract class AbstractOval implements IShape {
   ...
   * @param b blue value
   */
  public AbstractOval(double width, double height, int x, int y, double r, double g, double b)
  ...
  public String toString() {
    return "Type: " + this.getClass().getSimpleName()
            + "\nCenter: " + this.point.toString()
            + ", X radius: " + df.format(this.width)
            + ", Y radius: " + df.format(this.height)
